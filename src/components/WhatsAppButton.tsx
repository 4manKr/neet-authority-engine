...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-20 right-5 z-50 w-14 h-14 bg-green-500 text-white rounded-full shadow-lg shadow-green-500/30 flex items-center justify-center hover:bg-green-600 hover:scale-110 transition-all duration-300 group"
